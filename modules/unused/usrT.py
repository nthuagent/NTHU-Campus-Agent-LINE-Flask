...
def usr_carousel():
    ...
    intro_button_template = TemplateSendMessage(
        ...
        template=ButtonsTemplate(
            ...
            actions=[
                URITemplateAction(label="FB粉絲專頁", uri="https://reurl.cc/Ezabdk"),
                URITemplateAction(
                    label="清華大學USR網站",
        ...
        template=CarouselTemplate(
            columns=[
                CarouselColumn(
                    ...
                    actions=[
                        URIAction(
                            label="報名表單", uri="https://forms.gle/qLQiSE6EzJCAwQDX8"
                        )
                    ],
                ),
                CarouselColumn(
                    ...
                    actions=[
                        URIAction(
                            label="報名表單", uri="https://forms.gle/hGQ53B1aGib7kyd16"
                        )
                    ],
                ),
                CarouselColumn(
                    ...
                    actions=[
                        MessageTemplateAction(label="敬請期待", text="報名表單於活動前兩週公布"),
                    ],
                ),
                CarouselColumn(
                    thumbnail_image_url="https://i.imgur.com/69T75yw.jpg",
