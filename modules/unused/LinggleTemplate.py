        ...
        template=CarouselTemplate(
            columns=[
                ...
                CarouselColumn(
                    ...
                    actions=[
                        PostbackTemplateAction(
                            label="取得資訊", data="source=richmenu&flag=linggle&info=items"
                        )
                    ],
                ),
                CarouselColumn(
                ...
                CarouselColumn(
                    ...
                    text="【清大資工 AI+英語暑期工作坊】",
                    actions=[
                        URITemplateAction(label="取得資訊", uri="https://reurl.cc/E7yYy0")
                    ],
                ),
                CarouselColumn(
                    title="活動取消及退費標準",
                ...
                CarouselColumn(
                    ...
                    text="【清大資工 AI+英語暑期工作坊】",
                    actions=[
                        URITemplateAction(label="取得資訊", uri="http://home.linggle.com/")
                    ],
                ),
                CarouselColumn(
